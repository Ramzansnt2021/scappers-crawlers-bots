...
while counter >= 1:
    ...
    source = "C://Users//SBT DAY//Documents//jupyter_notebook//dataFiles//"
    skus = []
    category = []
    brands = []
    prod_ID = []
